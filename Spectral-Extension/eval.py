...
parser.add_argument('--resume_path', type=str, default='/home/t-nnaeem/workspace/RemoteSensingFoundationModels/Spectral-Extension/experiments/spectral_extension_20240722-175540/checkpoint/checkpoint_E80.tar', help='pretrained model path')
...
for batch_id, data in pbar:
    ...
    if num==1:
        out_fname = 'eval/'+args.model+'_pred_rgb.png'
        visualize_band(pred,out_fname,[2,1,0])
        out_fname = 'eval/'+args.model+'_pred_3.png'
        visualize_band(pred,out_fname,[3])
        out_fname = 'eval/'+args.model+'_pred_4.png'
        visualize_band(pred,out_fname,[4])
        out_fname = 'eval/'+args.model+'_pred_5.png'
        visualize_band(pred,out_fname,[5])
        out_fname = 'eval/'+args.model+'_pred_6.png'
        visualize_band(pred,out_fname,[6])
        out_fname = 'eval/'+args.model+'_pred_7.png'
        visualize_band(pred,out_fname,[7])
        out_fname = 'eval/'+args.model+'_pred_8.png'
        visualize_band(pred,out_fname,[8])
        out_fname = 'eval/'+args.model+'_pred_9.png'
        visualize_band(pred,out_fname,[9])

        out_fname = 'eval/'+args.model+'_out_rgb.png'
        visualize_band(out,out_fname,[2,1,0])
        out_fname = 'eval/'+args.model+'_out_3.png'
        visualize_band(out,out_fname,[3])
        out_fname = 'eval/'+args.model+'_out_4.png'
        visualize_band(out,out_fname,[4])
        out_fname = 'eval/'+args.model+'_out_5.png'
        visualize_band(out,out_fname,[5])
        out_fname = 'eval/'+args.model+'_out_6.png'
        visualize_band(out,out_fname,[6])
        out_fname = 'eval/'+args.model+'_out_7.png'
        visualize_band(out,out_fname,[7])
        out_fname = 'eval/'+args.model+'_out_8.png'
        visualize_band(out,out_fname,[8])
        out_fname = 'eval/'+args.model+'_out_9.png'
        visualize_band(out,out_fname,[9])


        out_fname = 'eval/'+args.model+'_inp_rgb.png'
        visualize_band(inp,out_fname,[2,1,0])
        out_fname = 'eval/'+args.model+'_inp_3.png'
        visualize_band(inp,out_fname,[3])
        out_fname = 'eval/'+args.model+'_inp_4.png'
        visualize_band(out,out_fname,[4])
        out_fname = 'eval/'+args.model+'_inp_5.png'
...
plt.savefig('eval/'+args.model+'_psnr.png')
...
plt.savefig('eval/'+args.model+'_ssim.png')
